...
$APPLICATION->SetPageProperty("title", "Вопросы и ответы на популярные вопросы от компании Дядя Лайфу");
$APPLICATION->SetPageProperty("description", "Популярные вопросы и ответы на тематику доставок груза из Китая, расскажем подробно как оплачивать и чем лучше доставлять товар из Китая");
