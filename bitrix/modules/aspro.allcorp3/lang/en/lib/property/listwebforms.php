...
$MESS["WEBFORMS_LINK_PROP_ALLCORP3_TITLE"] = "Aspro: Allcorp3. Binding to web forms";
...
1. General (from infoblock and web forms). Forms with the same character codes are displayed here. For example, \"Request a call\" with the symbolic code \"aspro_allcorp3_callback\" is available in web forms and in forms on information blocks. When choosing such a form, the marketing window will work regardless of the setting of the types of forms on the site. <br /> <br />
