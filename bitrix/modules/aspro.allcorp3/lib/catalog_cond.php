	...
	public static function GetLogic($arOperators = false)
	{
		$arOperatorsList = array(
			...
			AS_COND_LOGIC_GR => array(
				...
				'OP' => array(
					'N' => '#FIELD# > #VALUE#',
					'Y' => '\Aspro\Allcorp3\CGlobalCondCtrl::LogicGreat(#FIELD#, #VALUE#)'
				),
				'VALUE' => 'Great',
			...
			AS_COND_LOGIC_LS => array(
				...
				'OP' => array(
					'N' => '#FIELD# < #VALUE#',
					'Y' => '\Aspro\Allcorp3\CGlobalCondCtrl::LogicLess(#FIELD#, #VALUE#)'
				),
				'VALUE' => 'Less',
			...
			AS_COND_LOGIC_EGR => array(
				...
				'OP' => array(
					'N' => '#FIELD# >= #VALUE#',
					'Y' => '\Aspro\Allcorp3\CGlobalCondCtrl::LogicEqualGreat(#FIELD#, #VALUE#)'
				),
				'VALUE' => 'EqGr',
			...
			AS_COND_LOGIC_ELS => array(
				...
				'OP' => array(
					'N' => '#FIELD# <= #VALUE#',
					'Y' => '\Aspro\Allcorp3\CGlobalCondCtrl::LogicEqualLess(#FIELD#, #VALUE#)'
				),
				'VALUE' => 'EqLs',
			...
			AS_COND_LOGIC_CONT => array(
				...
				'OP' => array(
					...
					'Y' => '\Aspro\Allcorp3\CGlobalCondCtrl::LogicContain(#FIELD#, #VALUE#)'
				),
				'PARENT' => ' || ',
				'MULTI_SEP' => ' || ',
				'VALUE' => 'Contain',
			...
			AS_COND_LOGIC_NOT_CONT => array(
				...
				'OP' => array(
					'N' => 'false === strpos(#FIELD#, #VALUE#)',
					'Y' => '\Aspro\Allcorp3\CGlobalCondCtrl::LogicNotContain(#FIELD#, #VALUE#)'
				),
				'PARENT' => ' && ',
				'MULTI_SEP' => ' && ',
				'VALUE' => 'NotCont',
						...
						if (isset($arProp['USER_TYPE']) && !empty($arProp['USER_TYPE']))
						{
							switch ($arProp['USER_TYPE'])
							{
								...
								case 'directory':
									...
									$arValue = array(
										'type' => 'lazySelect',
										'load_url' => '/bitrix/tools/aspro.allcorp3/customfilter_ajax.php',
										'load_params' => array(
