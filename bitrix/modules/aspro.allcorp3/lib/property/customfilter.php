...
class CustomFilter{
	static function OnIBlockPropertyBuildList(){
		return array(
			...
			'DESCRIPTION' => Loc::getMessage('ALLCORP3_CUSTOM_FILTER_PROP_TITLE'),
	...
	static function GetPropertyFieldHtml($arProperty, $value, $strHTMLControlName){
		...
		if($bDetailPage){
			if(!isset($cache)){
				$cache = array();
				$jsFile = '/bitrix/js/aspro.allcorp3/property/customfilter_control.js';
				$ajaxFile = '/bitrix/tools/aspro.allcorp3/customfilter_ajax.php';
