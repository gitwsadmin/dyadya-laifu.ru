...
class ModalConditions{
	static function OnIBlockPropertyBuildList(){
		return array(
			'PROPERTY_TYPE' => 'S',
			'USER_TYPE' => 'SAsproModalConditionsAllcorp3',
			'DESCRIPTION' => Loc::getMessage('ALLCORP3_MODAL_CONDITIONS_PROP_TITLE'),
	...
	static function GetPropertyFieldHtml($arProperty, $value, $strHTMLControlName){
		...
		if($bDetailPage){
			if(!isset($cache)){
				$cache = array();
				$jsFile = '/bitrix/js/aspro.allcorp3/property/modalconditions_control.js';
				$ajaxFile = '/bitrix/tools/aspro.allcorp3/modalconditions_ajax.php';
