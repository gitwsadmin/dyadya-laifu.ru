...
class ConditionType{
	static function OnIBlockPropertyBuildList(){
		return array(
			'PROPERTY_TYPE' => 'L',
			'USER_TYPE' => 'SAsproModalConditionsTypeAllcorp3',
			'DESCRIPTION' => Loc::getMessage('ALLCORP3_MODAL_CONDITIONS_TYPES_PROP_TITLE'),
	...
	private static function addCss($arProperty){
		$GLOBALS['APPLICATION']->SetAdditionalCss('/bitrix/css/aspro.allcorp3/property/conditiontype.css');
	}
	...
	private static function addJs($arProperty, $dependProps){
		...
		$GLOBALS['APPLICATION']->AddHeadScript('/bitrix/js/aspro.allcorp3/property/conditiontype.js');
	}
}
