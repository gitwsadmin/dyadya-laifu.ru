			...
			<div class="form__wrapper <?=$formWrapperClass;?>">
				<!--noindex-->
					...
					<?=\Aspro\Functions\CAsproAllcorp3::showTitleInLeftBlock([
						'WRAPPER_CLASS' => 'form-header pt-20 flex-1',
						'PATH' => 'form-list',
						'PARAMS' => $arParams,
					]);?>
						...
						<div class="form-inner flex-1">
							...
							<div class="form-footer">
								...
								<div class="form-footer__btn">
									<input type="submit" onclick="ym(97297136,'reachGoal','sent_form'); return true;" class="<?=$arParams["SEND_BUTTON_CLASS"];?>" value="<?=($arParams["SEND_BUTTON_NAME"] ? $arParams["SEND_BUTTON_NAME"] : $arResult["arForm"]["BUTTON"]);?>" name="web_form_submit">
								</div>
							</div>
