...
if($bItemsTypeAlbums){
	...
	foreach($arResult['ITEMS'] as $key => $arItem){
		if($arPhotos = (is_array($arItem['PROPERTIES']['PHOTOS']) && array_key_exists('VALUE', $arItem['PROPERTIES']['PHOTOS']) && $arItem['PROPERTIES']['PHOTOS']['VALUE']) ? (array)$arItem['PROPERTIES']['PHOTOS']['VALUE'] : (array)$arItem['PROPERTY_PHOTOS_VALUE']){
