...
$APPLICATION->SetPageProperty("title", "Список услуг компании Дядя Лайфу");

$APPLICATION->SetPageProperty(
    "description",
    "Список услуг по доставке и хранению грузов от компании Дядя Лайфу из Китая. На ваш выбор доставка автомобильным транспортом, авиаперевозки, железнодорожные в страны - Россия, Казахстан, Киргизия"
);

$APPLICATION->SetTitle("Услуги компании Дядя Лайфу");
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"T_REVIEWS" => "",
		"T_SALE" => "",
		"T_SERVICES" => "Другие услуги Дяди Лайфу",
		"T_STAFF" => "",
		"T_VACANCY" => "",
		"T_VIDEO" => "",
		"USE_CATEGORIES" => "N",
		...
		"S_ASK_QUESTION" => "",
		"S_ORDER_SERVISE" => "Получить расчет",
		"FORM_ID_ORDER_SERVISE" => "",
		"T_DOPS" => "Этапы доставки",
		"DETAIL_BLOG_USE" => "Y",
