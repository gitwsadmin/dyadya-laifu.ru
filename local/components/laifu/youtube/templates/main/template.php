...
//        if ($currentPage === "/") {
            $h3Page = <<<EOF
                <div class="text-center">
                    <a href="https://www.youtube.com/@cargo-china">
                        <h3 class="h3-heading">Наши видео</h3>
                    </a>
                </div>
            EOF;
...
//        }
//        else {
//            $h3Page = \Aspro\Functions\CAsproAllcorp3::showTitleBlock([
//                'PATH'   => '',
//                'PARAMS' => $arParams,
//            ]);
//        }
