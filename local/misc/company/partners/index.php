...
$APPLICATION->SetPageProperty("title", "Партнеры - ffprosto ");
$APPLICATION->SetPageProperty("description", "Раздел Партнеров карго перевозчика Дяди Лайфу ↔ Услуги грузовых перевозок из Китая от компании Дядя Лайфу - На ваш выбор доставка автомобильным транспортом, авиаперевозки, железнодорожные перевозки. В страны - Россия, Казахстан, Киргизия ↔");
